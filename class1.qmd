...
2. Create a new variable named anes_vep_diff that computes the difference between the actual turnout rate (VEP_turnout) and ANES estimates of the turnout rate for each year. To do this, subtract one variable from the other, and save this as a new variable using <-
