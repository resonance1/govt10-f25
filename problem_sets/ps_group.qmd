...
# Note: if not using git, make sure that you move the data folder from the .zip to the same directory as the ps_group.qmd file 
...
#polls24 <- read.csv("data/polls24.csv") To be provided later
